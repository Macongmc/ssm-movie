...
public interface MovieDao {
     ...
     * @return 影响行数
     */
    int deleteById(Long movieId);

    List<Movie> findAllMovies(@Param("movieState") int movieState);

    List<Movie> sortMovieByScore();

    List<Movie> findMoviesLikeType(@Param("order") String order,@Param("type") String type,@Param("area") String area,@Param("year") String year, @Param("searchMovie") String searchMovie);
}
